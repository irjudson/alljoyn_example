...
var app = {
    ...
    bindEvents: function() {
        ...
        document.getElementById('alljoynDiscoverStart').addEventListener('click', this.alljoynDiscoverStart, false);
        document.getElementById('alljoynDiscoverStop').addEventListener('click', this.alljoynDiscoverStop, false);
    },
